...
DATA_URL = "https://gist.githubusercontent.com/sorokadima/a6ba9a0864ef7bbd1648e198c14ddfb6/raw/4bf08de5d79ac26b3dda1391383ddff5e2cee83f/%25D0%25A3%25D0%25BA%25D1%2580%25D0%25B0%25D1%2597%25D0%25BD%25D1%2581%25D1%258C%25D0%25BA%25D1%2596%2520%25D1%2596%25D0%25BC%25D0%25B5%25D0%25BD%25D0%25B0%2520%25D1%2581%25D0%25BF%25D0%25B8%25D1%2581%25D0%25BE%25D0%25BA.txt"
DATA_PATH = MODEL_ROOT / "data" / "uk_name.txt"
CHECKPOINT_PATH = MODEL_ROOT / "checkpoints" / "uk_model.pkl"
APP_DATA_DIR = REPO_ROOT / "app" / "public" / "data"
APP_DATASET_PATH = APP_DATA_DIR / "uk_name.txt"
APP_EMBEDDING_PATH = APP_DATA_DIR / "uk_embedding_snapshot.json"
APP_TRACE_PATH = APP_DATA_DIR / "uk_training_trace.json"
...
def load_dataset(data_path: Path = DATA_PATH):
    ...
    english_docs = [name for name in raw_docs if re.fullmatch(r"[а-я]+", name)]
