  ...
  en: {
    hero: {
      ...
      projectInfoEndByExampleLanguage: {
        ...
        en: ' та візуалізує внутрішній процес GPT моделі, яка генерує англійські імена.',
      },
    ...
    outro: {
      ...
      messageByExampleLanguage: {
        ...
        en: 'Ви дізналися про весь процес створення англійських імен через microgpt!',
      },
